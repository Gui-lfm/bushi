...
function Anime() {
  ...
  const { isLoading, isError, data, error, isSuccess } = useGetAnimeQuery();
  ...
  if (isLoading) {
    ...
    content = <div>código do erro {error.status.toString()} </div>;
  } else if (isSuccess) {
            ...
            <div key={anime.id}>
              <section className="anime">
                ...
                <div className="anime__detalhes">
                  <h1 className="anime__titulo">
                    Nome do anime: {anime.title}{" "}
                  </h1>
